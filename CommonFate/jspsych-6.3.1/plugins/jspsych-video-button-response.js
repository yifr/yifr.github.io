...
jsPsych.plugins["video-button-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // setup stimulus
    var video_html = '<div>'
    video_html += '<video id="jspsych-video-button-response-stimulus" style="border: 3px solid blue"';
    ...
    for (var i = 0; i < trial.choices.length; i++) {
      ...
      video_html += '<div class="jspsych-video-button-response-button" style="width: 30%; cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-video-button-response-button-' + i +'" data-choice="'+i+'">'+str+'</div>';
    }
    video_html += '</div>';
